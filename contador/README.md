...
El contador muestra un número que puede ser:
- **Incrementado** presionando el botón "+ Incrementar"
- **Decrementado** presionando el botón "- Decrementar"
- **Reseteado a 0** presionando el botón "Resetear"
